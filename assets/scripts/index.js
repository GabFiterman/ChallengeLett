(function () {
    ...
    async function getUser(user) {
        ...
        const reposResponse = await fetch(
            `${url}/users/${user}/repos?per_page=${count}&sort=${sort}&client_id=${client_id}&client_secret=${client_secret}`
        );
    ...
    async function getReposFiltered(reposName) {
        const reposResponse = await fetch(
            `${url}/repos/${user}/${reposName}?per_page=${count}&sort=${sort}&client_id=${client_id}&client_secret=${client_secret}`
        );
    ...
    function showReposFiltered(repos) {
        ...
        <div class="card">
        <a class="cardName" href="${repos.html_url}" target="_blank">${repos.name}</a>
        ...
        <div class="cardStatisticsGroup">
            ...
            <span class="cardStatistic cardStar">
                ...
                <p class="starName">Star: <strong class="starCount">${repos.stargazers_count}</strong></p>
            </span>
            ...
            <span class="cardStatistic cardWatch">
                ...
                <p class="watchName">Watch: <strong class="watchCount">${repos.watchers_count}</strong></p>
            </span>
            ...
            <span class="cardStatistic cardFork">
                ...
                <p class="forkName">Fork: <strong class="forkCount">${repos.forks_count}</strong></p>
            </span>
